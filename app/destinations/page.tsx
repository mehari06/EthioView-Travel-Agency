...
const fallbackDestinations = [
  ...
  },
  {
    ...
    name: "Addis Ababa",
    region: "Addis Ababa",
    description: "Ethiopia's vibrant capital with museums, culture, and modern city life.",
    image: "/images/addisabeba.jpg",
    highlights: ["National Museum", "Mercato", "Cultural cuisine"],
  },
  {
    id: 3,
    name: "Lalibela",
  ...
  },
  {
    ...
    description: "A culturally rich region known for diverse communities and traditions.",
    image: "/images/omoperson.jpg",
    highlights: ["Local tribes", "Colorful markets", "Cultural immersion"],
  },
  {
    id: 5,
    name: "Harar",
    region: "Harari",
    description: "A historic walled city with unique architecture and living heritage.",
    image: "/images/harrarwall.jpg",
    highlights: ["Old city walls", "Hyena feeding", "Ancient alleys"],
  },
  {
    id: 6,
    name: "Bahir Dar",
    region: "Amhara",
    description: "Lakeside city gateway to monasteries and the Blue Nile Falls.",
    image: "/images/bahirdarcity.jpg",
    highlights: ["Lake Tana", "Monasteries", "Blue Nile Falls"],
  },
  {
    id: 11,
    name: "Hawassa",
